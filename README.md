...
* Construção e interpretação de visualizações gráficas essenciais, com destaque para o uso de **Histogramas** e **Boxplots** para identificação de tendências e *outliers*
